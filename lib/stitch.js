...
(function() {
  var CoffeeScript, Package, async, compilers, eco, extname, fs, join, minimatch, normalize, _, _ref,
  ...
  exports.Package = Package = (function() {
      ...
      return fs.stat(sourcePath, function(err, stat) {
        ...
        if (stat.isDirectory()) {
          return _this.getFilesInTree(sourcePath, function(err, paths) {
            ...
            paths = _this.filterPaths(paths, patterns);
            return async.reduce(paths, sources, _.bind(_this.gatherCompilableSource, _this), callback);
          });
        } else {
          if (_this.filterPaths([sourcePath], patterns).length) {
    ...
    Package.prototype.filterPaths = function(paths, patterns) {
      return _.filter(paths, function(path) {
        var matches, pattern, _i, _len;
        matches = true;
